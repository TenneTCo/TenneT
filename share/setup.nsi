...
!define URL http://www.tennet.ru/

# MUI Symbol Definitions
!define MUI_ICON "../share/pixmaps/tennet.ico"
...
#!define MUI_FINISHPAGE_RUN $INSTDIR\tennet-qt.exe
...
OutFile tennet-0.3.0-win32-setup.exe
...
Section -Main SEC0000
    SetOutPath $INSTDIR
    SetOverwrite on
    #File ../release/tennet-qt.exe
    File /oname=license.txt ../COPYING
    File /oname=readme.txt ../doc/README_windows.txt
    SetOutPath $INSTDIR\daemon
    File ../src/tennetd.exe
    ...
    #Delete /REBOOTOK $INSTDIR\tennet.exe
...
Section /o -un.Main UNSEC0000
    #Delete /REBOOTOK $INSTDIR\tennet-qt.exe
